...
public class FlappyBird
{
    ...
    int highscore;
    Player scores[];
    ImageDisplayer background, bird, title;
    KeyPress k;
    Pipes p;
    String playerName;
    ...
    int birdY;
    final int speed = 10;
    final int gravity = 13;
    boolean running, gameover;
...
//This Method will create the splashscreen for the game
//No Parameters
//No return values
...
//This method will display the score which playing the game
//no Parameters
//No Return values
	...
	c.drawString (String.valueOf (p.score), 310, 100);
...
//This method will create the main menu of the Game
//no Parameters
//No return values
...
//This method will read a file containing high scores
//No parameters
//No Return Values
...
//This method wil display the leaderboard
//no parameters
//no return values
...
//This method will draw the Flappy bird character
...
//This method will draw the background
//No parameters
//no return values
...
//This method will draw the Flappy bird title image
//2 parameters: int x,y
//No return values
...
//This method will start the flappy bird game
//No parameters
//no return methods
...
//This method will display a message after you died
//One parameter: boolean quitted
//No return values
...
//This method will write the leaderboard into a file
//No parameters
//No return methods
